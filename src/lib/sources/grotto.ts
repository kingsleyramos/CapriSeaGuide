...
/** The live-bar path only; the recorder passes `fresh` and bypasses this. Kept
 *  in step with the Cache-Control on /api/grotto, and no shorter: every miss is
 *  a request to someone else's website. */
